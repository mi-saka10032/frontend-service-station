...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="反向代理" tabindex="-1"><a class="header-anchor" href="#反向代理" aria-hidden="true">#</a> 反向代理</h2><p>在聊反向代理之前，我们先看看正向代理，正向代理也是大家最常接触的到的代理模式</p><h3 id="正向代理" tabindex="-1"><a class="header-anchor" href="#正向代理" aria-hidden="true">#</a> 正向代理</h3><p>&quot;正向代理代理的是客户端&quot;，是一个位于客户端和原始服务器(origin server)之间的服务器，为了从原始服务器取得内容，客户端向代理发送一个请求并指定目标(原始服务器)，然后代理向原始服务器转交请求并将获得的内容返回给客户端。客户端必须要进行一些特别的设置才能使用正向代理</p><figure><img src="https://misaka10032.oss-cn-chengdu.aliyuncs.com/performance/forward-proxy.webp" alt="正向代理图例" tabindex="0" loading="lazy"><figcaption>正向代理图例</figcaption></figure><p>正向代理的用途：</p><ul><li>访问原来无法访问的资源，如 Google</li><li>可以做缓存，加速访问资源</li><li>对客户端访问授权，上网进行认证</li><li>代理可以记录用户访问记录（上网行为管理），对外隐藏用户信息</li></ul><h3 id="反向代理-1" tabindex="-1"><a class="header-anchor" href="#反向代理-1" aria-hidden="true">#</a> 反向代理</h3><p>&quot;反向代理代理的是服务端&quot;，主要用于服务器集群分布式部署的情况下，反向代理隐藏了服务器的信息</p><figure><img src="https://misaka10032.oss-cn-chengdu.aliyuncs.com/performance/reverser-proxy.webp" alt="反向代理图例" tabindex="0" loading="lazy"><figcaption>反向代理图例</figcaption></figure><p>反向代理的作用：</p><ul><li>保证内网的安全，通常将反向代理作为公网访问地址，Web 服务器是内网</li><li>负载均衡，通过反向代理服务器来优化网站的负载</li></ul><div class="language-conf line-numbers-mode" data-ext="conf"><pre class="language-conf"><code>server {
		#此处省略一些基本配置
		#默认指向product的server
		location / {
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="fair" tabindex="-1"><a class="header-anchor" href="#fair" aria-hidden="true">#</a> fair</h3><p>fair 算法可以根据页面大小和加载时间长短智能地进行负载均衡，响应时间短的优先分配</p>`,65),m={href:"https://www.cnblogs.com/xiaohanlin/p/9904487.html",target:"_blank",rel:"noopener noreferrer"},b=e(`<p>哪个服务器响应速度快，就将请求分配到那个服务器上</p><div class="language-conf line-numbers-mode" data-ext="conf"><pre class="language-conf"><code>
upstream constPolling {
 server    localhost:10001;
 server    localhost:10002;
 fair;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>注意：当前大部分前端构建工具均支持生产环境直接打包 Gzip，nginx 可以不必配置！</p><h2 id="实际场景" tabindex="-1"><a class="header-anchor" href="#实际场景" aria-hidden="true">#</a> 实际场景</h2><h3 id="同一域名不同项目" tabindex="-1"><a class="header-anchor" href="#同一域名不同项目" aria-hidden="true">#</a> 同一域名不同项目</h3><p>通过同一域名的不同目录，来指定不同项目目录。微前端、多项目系统中都有使用</p><figure><img src="https://misaka10032.oss-cn-chengdu.aliyuncs.com/performance/nginx-all-one.png" alt="nginx同一域名不同项目" tabindex="0" loading="lazy"><figcaption>nginx同一域名不同项目</figcaption></figure><h3 id="自动适配-pc-移动端页面" tabindex="-1"><a class="header-anchor" href="#自动适配-pc-移动端页面" aria-hidden="true">#</a> 自动适配 PC/移动端页面</h3><figure><img src="https://misaka10032.oss-cn-chengdu.aliyuncs.com/performance/nginx-mobile.png" alt="nginx适配移动端" tabindex="0" loading="lazy"><figcaption>nginx适配移动端</figcaption></figure><h3 id="限制谷歌浏览器访问" tabindex="-1"><a class="header-anchor" href="#限制谷歌浏览器访问" aria-hidden="true">#</a> 限制谷歌浏览器访问</h3><figure><img src="https://misaka10032.oss-cn-chengdu.aliyuncs.com/performance/nginx-chrome.png" alt="nginx限制谷歌访问" tabindex="0" loading="lazy"><figcaption>nginx限制谷歌访问</figcaption></figure><h3 id="spa-刷新-404" tabindex="-1"><a class="header-anchor" href="#spa-刷新-404" aria-hidden="true">#</a> SPA 刷新 404</h3><figure><img src="https://misaka10032.oss-cn-chengdu.aliyuncs.com/performance/nginx-404.png" alt="nginx限制谷歌访问" tabindex="0" loading="lazy"><figcaption>nginx限制谷歌访问</figcaption></figure><p><strong>注意：这个场景对于前端 SPA 应用路由模式为 history 时，为必须配置项！！！</strong></p><p><code>try_files $uri #uri/ /index.html;</code>这行字的意思为</p><ol><li><p>当 url 跳转链接找不到有效路径时，返回到 index.html 文件中让 html 自行处理逻辑</p></li><li><p>跳转回 index.html 中后，前端框架的 router 路由依赖劫持 url 监听器事件，触发无刷新页面渲染</p></li></ol>`,20);function h(p,g){const a=d("ExternalLinkIcon");return r(),c("div",null,[v,n("p",null,[i("参考链接："),n("a",o,[i("https://blog.csdn.net/sinat_17775997/article/details/127506978"),s(a)])]),u,n("p",null,[i("注意：需要安装 upstream_fair 模块，"),n("a",m,[i("安装教程"),s(a)])]),b])}const f=l(t,[["render",h],["__file","6-nginx.html.vue"]]);export{f as default};
