import{_ as a,C as t,Y as p,Z as e,$ as n,a0 as o,a2 as c,a1 as i}from"./framework-bb209140.js";const l={},u=i(`<p>React 提供的 hooks 函数中，useReducer 提供了类似 redux 的数据状态管理功能，其底层原理大体分为三步：mountReducer -&gt; updateReducer -&gt; commitReducer，分别代表挂载、更新、提交更改的全过程</p><h2 id="mountreducer" tabindex="-1"><a class="header-anchor" href="#mountreducer" aria-hidden="true">#</a> mountReducer</h2><figure><img src="https://misaka10032.oss-cn-chengdu.aliyuncs.com/React/mountReducer.png" alt="mountReducer" tabindex="0" loading="lazy"><figcaption>mountReducer</figcaption></figure><h3 id="main-jsx" tabindex="-1"><a class="header-anchor" href="#main-jsx" aria-hidden="true">#</a> main.jsx</h3><p>src\\main.jsx</p><div class="language-jsx line-numbers-mode" data-ext="jsx"><pre class="language-jsx"><code><span class="token keyword">import</span> <span class="token operator">*</span> <span class="token keyword">as</span> React <span class="token keyword">from</span> <span class="token string">&quot;react/index&quot;</span><span class="token punctuation">;</span>
