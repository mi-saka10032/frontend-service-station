...
<span class="token punctuation">}</span>
  ...
  <span class="token keyword">return</span> listener<span class="token punctuation">;</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="流程图" tabindex="-1"><a class="header-anchor" href="#流程图" aria-hidden="true">#</a> 流程图</h2><p>事件监听流程图</p><figure><img src="https://misaka10032.oss-cn-chengdu.aliyuncs.com/React/DOMPluginEventSystem.jpg" alt="DOMPluginEventSystem" tabindex="0" loading="lazy"><figcaption>DOMPluginEventSystem</figcaption></figure><p>事件派发流程图</p><figure><img src="https://misaka10032.oss-cn-chengdu.aliyuncs.com/React/extractEvents.jpg" alt="extractEvents" tabindex="0" loading="lazy"><figcaption>extractEvents</figcaption></figure><p>事件处理流程图</p><figure><img src="https://misaka10032.oss-cn-chengdu.aliyuncs.com/React/processDispatchQueue.jpg" alt="processDispatchQueue" tabindex="0" loading="lazy"><figcaption>processDispatchQueue</figcaption></figure><h2 id="最终输出结果" tabindex="-1"><a class="header-anchor" href="#最终输出结果" aria-hidden="true">#</a> 最终输出结果</h2><p>main.jsx</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">import</span> <span class="token punctuation">{</span> createRoot <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">&quot;react-dom/client&quot;</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>点击 world 之后控制台打印结果：</p><figure><img src="https://misaka10032.oss-cn-chengdu.aliyuncs.com/React/eventSystem-result.png" alt="eventSystemResult" tabindex="0" loading="lazy"><figcaption>eventSystemResult</figcaption></figure><h2 id="手写源码仓库" tabindex="-1"><a class="header-anchor" href="#手写源码仓库" aria-hidden="true">#</a> 手写源码仓库</h2>`,73),r={href:"https://github.com/mi-saka10032/mini-react/tree/master/packages/events",target:"_blank",rel:"noopener noreferrer"};function k(d,v){const s=t("ExternalLinkIcon");return e(),p("div",null,[u,n("p",null,[n("a",r,[o("https://github.com/mi-saka10032/mini-react/tree/master/packages/events"),c(s)])])])}const b=a(l,[["render",k],["__file","3-event.html.vue"]]);export{b as default};
